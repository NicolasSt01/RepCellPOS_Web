    ...
    public function run(): void
    {
        Plan::create([
            ...
            'features' => [
                ...
                'report.ventas-periodo' => false,
                'report.ventas-productos' => false,
                'report.ventas-pago' => false,
                'report.ventas-ticket' => false,
                'report.taller-productividad' => false,
                'report.taller-ciclo-vida' => false,
                'report.taller-sla' => false,
                'report.taller-cotizaciones' => false,
                'report.taller-dispositivos' => false,
                'report.inventario-valorizacion' => false,
                'report.inventario-rotacion' => false,
                'report.inventario-kardex' => false,
                'report.caja-cuadre' => false,
                'report.caja-flujo' => false,
                'report.clientes-retencion' => false,
                'report.clientes-top' => false,
                'report.cotizaciones-aprobacion' => false,
            ],
            'limits' => [
                'max_users' => 1,
                'max_clients' => 50,
