    ...
    <section id="pricing" class="py-20 sm:py-28 bg-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="mt-2 text-3xl sm:text-4xl font-bold text-gray-900">Un plan simple para tu taller</h2>
            </div>

            <div class="mx-auto max-w-lg">
                <div class="relative bg-white rounded-2xl shadow-xl ring-2 ring-indigo-600 p-8">
                    ...
                    <div class="text-center">
                        <h3 class="text-lg font-semibold text-gray-900">Plan Taller</h3>
                        ...
                        <p class="mt-2 text-sm text-gray-500">Gratis durante la fase beta</p>
                    </div>
                    ...
                    <a href="{{ route('register') }}" class="mt-8 block w-full text-center rounded-lg bg-indigo-600 px-4 py-3 text-base font-semibold text-white shadow-sm hover:bg-indigo-500 transition-colors">
                        Crear mi taller gratis
                    </a>
                </div>
            </div>
