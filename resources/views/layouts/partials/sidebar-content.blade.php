...
<nav class="flex flex-1 flex-col">
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <ul role="list" class="-mx-2 mt-2 space-y-1">
                ...
                <li>
                    <a href="{{ route('work_orders.reports') }}"
                        class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 {{ str_contains($currentRoute, 'work_orders.reports') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700' }}">
            ...
            <ul role="list" class="-mx-2 mt-2 space-y-1">
                ...
                <li>
                    <a href="{{ route('returns.index') }}"
                        ...
                        <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3" /></svg>
                        Devoluciones
                    </a>
                </li>
                @endcan
        ...
        @if($isSuperAdmin)
        <li>
            <div class="text-xs font-semibold leading-6 text-gray-400 dark:text-gray-500 uppercase tracking-wider">Plataforma</div>
            <ul role="list" class="-mx-2 mt-2 space-y-1">
                <li>
                    <a href="{{ route('admin.dashboard') }}"
                        class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 {{ request()->routeIs('admin.dashboard') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700' }}">
